...
<title>El Altar del Gusto</title>
  ...
  <div class="container"> 
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><a src="form/img/logo.jpg" class="img-responsive" alt=""></a></li>
        ...
        <li><a href="admin/login.php" class="page-scroll">Incio sesiòn</a></li>
      </ul>
    </div>
    <!-- /.navbar-collapse --> 
  </div>
      ...
      <div class="container">
        <div class="row">
          <div class="intro-text">
            <h1>El Altar del Gusto </h1>
            <p>Reservaciones: (+56) 920147789</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div id="row">
      <div class="col-md-6">
        <div class="col-md-10 col-md-offset-1">
          ...
          <p>Luis Robledo inició su viaje en el arte culinario a los 16 años en las aulas del Instituto Gastronómico de Ciudad de México. Su carrera profesional lo ha llevado a destacarse en las cocinas de renombrados establecimientos internacionales, como el restaurante Le Bernardin en Nueva York, el exclusivo Hotel George V en París y el emblemático restaurante Pujol en su tierra natal.</p>
         <p> Hasta finalmente dar vida a El Altar del Gusto, un espacio único en San Fernando, donde combina tradición local con innovadoras técnicas culinarias, convirtiéndolo en un referente de la cocina de autor en la región.</p>
        </div>
      </div>
      <div class="col-md-6">
...
<div id="footer">
  <div class="container text-center">
    <div class="col-md-6">
      <p>&copy; 2024 El Altar del Gusto. Todos los derechos reservados.</p>
    </div>
    <div class="col-md-6">
      <div class="social">
        <ul>
